...
.trafficlight{background:url(image.php?theme=fusion&image=navflagged&rev=159&component=quiz) no-repeat top right}.path-mod-quiz .qnbutton.notyetanswered,
...
li{background-image:url(image.php?theme=fusion&image=userplan%2Ftask-todo&rev=159&component=mod_workshop);background-position:top left;background-repeat:no-repeat;list-style-type:none}.path-mod-workshop .userplan tr.phasetasks
li.completed{background-image:url(image.php?theme=fusion&image=userplan%2Ftask-done&rev=159&component=mod_workshop)}.path-mod-workshop .userplan tr.phasetasks
li.fail{background-image:url(image.php?theme=fusion&image=userplan%2Ftask-fail&rev=159&component=mod_workshop)}.path-mod-workshop .userplan tr.phasetasks
li.info{background-image:url(image.php?theme=fusion&image=userplan%2Ftask-info&rev=159&component=mod_workshop)}.path-mod-workshop .userplan tr.phasetasks
...
0 4px;padding:0px;width:100px;height:20px;position:relative;background:url(image.php?theme=fusion&image=i%2Fstar-rating&rev=159) top left repeat-x;float:left}#page-blocks-community-communitycourse .star-rating
li{padding:0px;margin:0px;height:20px;width:20px;float:left}#page-blocks-community-communitycourse .star-rating li.current-rating{background:url(image.php?theme=fusion&image=i%2Fstar-rating&rev=159) left bottom;position:absolute;height:20px;display:block;text-indent: -9000px;z-index:1}#page-blocks-community-communitycourse
...
.editbutton{text-align:right}.dndupload-preview{color:#909090;border:1px
dashed #909090}.dndupload-progress-outer{width:70px;border:solid black 1px;height:10px;display:inline-block;margin:0;padding:0;overflow:clip;position:relative}.dndupload-progress-inner{width:0%;height:100%;background-color:green;display:inline-block;margin:0;padding:0;float:left}.dndupload-hidden{display:none}.block.block_html
...
.tree_item.branch{background-image:url(image.php?theme=fusion&image=t%2Fexpanded&rev=159);background-position:0 10%;background-repeat:no-repeat}.block_navigation .block_tree
...
.tree_item.emptybranch{background-image:url(image.php?theme=fusion&image=t%2Fcollapsed_empty&rev=159);background-position:0% 5%;background-repeat:no-repeat}.jsenabled .block_navigation .block_tree .collapsed
ul{display:none}.jsenabled .block_navigation .block_tree .collapsed
.tree_item.branch{background-image:url(image.php?theme=fusion&image=t%2Fcollapsed&rev=159)}.jsenabled .block_navigation .block_tree
.tree_item.branch.loadingbranch{background-image:url(image.php?theme=fusion&image=i%2Floading_small&rev=159)}.jsenabled .block_navigation.dock_on_load,
...
.tree_item.emptybranch{background-image:url(image.php?theme=fusion&image=t%2Fcollapsed_empty_rtl&rev=159);background-position:center right}.jsenabled.dir-rtl .block_navigation .block_tree .collapsed
.tree_item.branch{background-image:url(image.php?theme=fusion&image=t%2Fcollapsed_rtl&rev=159)}.block_online_users .content .list
...
.tree_item.branch{background-image:url(image.php?theme=fusion&image=t%2Fexpanded&rev=159);background-position:0 10%;background-repeat:no-repeat}.block_settings .block_tree
.root_node.leaf{padding-left:0px}.block_settings .block_tree
.active_tree_node{font-weight:bold}.jsenabled .block_settings .block_tree
.tree_item.branch{cursor:pointer}.jsenabled .block_settings .block_tree
.tree_item.emptybranch{background-image:url(image.php?theme=fusion&image=t%2Fcollapsed_empty&rev=159);background-position:0 10%;background-repeat:no-repeat}.jsenabled .block_settings .block_tree .collapsed
ul{display:none}.jsenabled .block_settings .block_tree .collapsed
.tree_item.branch{background-image:url(image.php?theme=fusion&image=t%2Fcollapsed&rev=159)}.ie6 .block_settings .block_tree
...
.tree_item.emptybranch{background-image:url(image.php?theme=fusion&image=t%2Fcollapsed_empty_rtl&rev=159);background-position:center right}.jsenabled.dir-rtl .block_settings .block_tree .collapsed
.tree_item.branch{background-image:url(image.php?theme=fusion&image=t%2Fcollapsed_rtl&rev=159)}.block_tag_flickr .flickr-photos{padding:3px}.block_tag_youtube .youtube-thumb{padding:3px;padding-bottom:0.5em;display:block;float:left}.block_tag_youtube .yt-video-entry
...
a{color:#88c}input[type=text],input[type=password],textarea{width:auto}th,
td,
a
...
.ygtvtn{background:url(image.php?theme=fusion&image=y%2Ftn&rev=159) 0 0 no-repeat;width:17px;height:22px}.file-picker
.ygtvtm{background:url(image.php?theme=fusion&image=y%2Ftm&rev=159) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvtmh{background:url(image.php?theme=fusion&image=y%2Ftmh&rev=159) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvtp{background:url(image.php?theme=fusion&image=y%2Ftp&rev=159) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvtph{background:url(image.php?theme=fusion&image=y%2Ftph&rev=159) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvln{background:url(image.php?theme=fusion&image=y%2Fln&rev=159) 0 0 no-repeat;width:17px;height:22px}.file-picker
.ygtvlm{background:url(image.php?theme=fusion&image=y%2Flm&rev=159) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvlmh{background:url(image.php?theme=fusion&image=y%2Flmh&rev=159) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvlp{background:url(image.php?theme=fusion&image=y%2Flp&rev=159) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvlph{background:url(image.php?theme=fusion&image=y%2Flph&rev=159) 0 0 no-repeat;width:34px;height:22px;cursor:pointer}.file-picker
.ygtvloading{background:url(image.php?theme=fusion&image=y%2Floading&rev=159) 0 0 no-repeat;width:16px;height:22px}.file-picker
.ygtvdepthcell{background:url(image.php?theme=fusion&image=y%2Fvline&rev=159) 0 0 no-repeat;width:17px;height:22px}.file-picker
...
.smartselect_submenuitem{background-image:url(image.php?theme=fusion&image=t%2Fcollapsed&rev=159);background-repeat:no-repeat;background-position:100%}.smartselect.spanningmenu
...
.dir-rtl .ygtvcancel,
.dir-rtl .ygtvcancel:hover{width:18px;height:22px;background-image:url(image.php?theme=fusion&image=yui2-treeview-sprite-rtl&rev=159&component=theme);background-repeat:no-repeat;cursor:pointer}.dir-rtl
...
.ajaxworking{position:absolute;top:0;left:20px;width:20px;height:20px;background:url(image.php?theme=fusion&image=i%2Fajaxloader&rev=159) no-repeat}.dir-rtl.path-course-view
...
div{display:inline;cursor:pointer}.course_category_tree .category.with_children>.category_label{background-image:url(image.php?theme=fusion&image=t%2Fexpanded&rev=159);background-repeat:no-repeat}.course_category_tree
...
.course_link{display:block;background-image:url(image.php?theme=fusion&image=i%2Fcourse&rev=159);background-repeat:no-repeat;padding-left:18px}.course_category_tree .category
...
.category_label{background-image:url(image.php?theme=fusion&image=t%2Fcollapsed&rev=159)}.jsenabled .course_category_tree .category.with_children.collapsed .subcategories,
...
.category_label{background-image:url(image.php?theme=fusion&image=t%2Fcollapsed_rtl&rev=159)}.dir-rtl .course_category_tree .category .courses
...
.minicalendar
th{background:url(image.php?theme=fusion&image=gradient-sb&rev=159&component=theme) repeat-x 0 0}.maincalendar .calendar-controls{padding:10px
...
.environmenttable th,
.forumheaderlist
th{background:#f3f3f3;border-bottom-width:2px}body.pagelayout-popup{background:#fff !important}html,body{height:100%}html{font-size:100%}body{min-height:100%;height:auto !important;height:100%;position:relative;background:#fff url(image.php?theme=fusion&image=main-bg&rev=159&component=theme) repeat-x left 150px}body#page-site-index{background-position:left 200px}body,h1,h2,h3,h4,h5,h6,p,ul,ol,dl,input,textarea{font-family:"Lucida Grande","Lucida Sans Unicode",Arial,Helvetica,Sans,FreeSans,Jamrul,Garuda,Kalimati;line-height:1.5;color:#333}a{color:#2d83d5}a:hover{color:#333;text-decoration:none}#wrapper{padding:0
100px;min-width:910px}blockquote{border-left:1px solid #eee;padding-left:15px;color:#666}.mform
fieldset{border-color:#eee}.mform fieldset
legend{color:#444;font-weight:normal;font-size:1.2em;border:1px
solid #eee;padding:2px
5px;background:#fff}img{border:0}h1{font-size:250%;margin: .5em 0 .2em;font-weight:bold;letter-spacing:-0.06em}h2{font-family:"Palatino Linotype",Georgia,"Tahoma","Century Schoolbook L",Arial,Helvetica;font-size:160%;font-weight:bold;margin: .2em 0 .2em;letter-spacing: -0.04em}h3{font-family:"Lucida Grande","Lucida Sans Unicode",Arial,Helvetica,Sans,FreeSans,Jamrul,Garuda,Kalimati;font-size:150%;font-weight:bold;margin: .2em 0 .2em;letter-spacing:-0.06em}h4{font-family:ArialNarrow,Arial,Helvetica,Geneva;font-size:140%;font-weight:bold;margin: .2em 0 .2em}h5{font-family:"Lucida Grande","Lucida Sans Unicode",Arial,Helvetica,Sans,FreeSans,Jamrul,Garuda,Kalimati;font-size:115%;font-weight:normal;margin: .2em 0 .2em;text-transform:uppercase;font-style:italic}h6{font-family:"Lucida Grande","Lucida Sans Unicode",Arial,Helvetica,Sans,FreeSans,Jamrul,Garuda,Kalimati;font-size:110%;font-weight:bold;margin: .2em 0 .2em}#page-site-index #page-wrap1{background:transparent url(image.php?theme=fusion&image=header-bg&rev=159&component=theme) repeat-x left top}#page-site-index #page-wrap2{background:transparent url(image.php?theme=fusion&image=header-center&rev=159&component=theme) no-repeat center top}#page-wrap1{background:transparent url(image.php?theme=fusion&image=header-bg-sm&rev=159&component=theme) repeat-x left top}#page-wrap2{background:transparent url(image.php?theme=fusion&image=header-center-sm&rev=159&component=theme) no-repeat center top}#page-header{padding:0}#page-site-index #region-header{margin-bottom:65px}#region-header{margin-bottom:40px}.headermain{margin:0;float:none;font-family:"Trajan Pro","Lucida Sans Unicode",Arial,Helvetica,Sans,FreeSans,Jamrul,Garuda,Kalimati;float:none;font-size:3em;line-height:1;text-shadow: -0.05em -0.05em 0 #000;color:#fff}#region-header.inside
.headermain{font-size:2.5em}.tagline{color:#a2a3a6;text-shadow: -0.1em -0.1em 0 #000}.headermenu{color:#fff;float:none;margin:5px
25px 0 0}.headermenu
a{color:#a2a3a6}.headermenu a:hover{color:#fff}#page-header .logininfo,
#page-header
.langmenu{float:right}#page-header
.logininfo{padding:2px
5px 0 0}.navbar{margin-bottom:1em}.breadcrumb
.sep{padding-left:5px;font-size:0.9em}#region-post-wrap-1{background:url(image.php?theme=fusion&image=side-start&rev=159&component=theme) no-repeat 0 0;padding-left:28px}#region-post-wrap-2{background:url(image.php?theme=fusion&image=side-bg&rev=159&component=theme) no-repeat 100% 0;padding-right:40px;padding-top:15px}.block{border:none}.block
.header{border-bottom:1px solid #eee;padding:0}.block .header
h2{font-family:"Lucida Grande","Lucida Sans Unicode",Arial,Helvetica,Sans,FreeSans,Jamrul,Garuda,Kalimati;font-weight:normal;text-transform:uppercase;font-size:1.2em;color:#777;margin:0}h2.headingblock{font-weight:normal;color:#999;font-size:1.5em;border-bottom:1px dotted #eee}.coursebox{border-color:#eee}.coursebox
.info{width:35%}.coursebox .info
.name{margin-bottom:0}.coursebox .info
.teachers{font-size:0.9em;color:#888}.coursebox
.summary{width:63%}.course-content
.section.main{border-bottom:1px solid #eee}.course-content .section.main
.content{padding:5px
5px 10px}.course-content .weeks .section.main
.content{margin-left:0}.course-content .weeks .section.main
.left{display:none}.course-content
.section.main.current{background:#fffcdc}.course-content .weeks .section.main
h3.weekdates{color:#999}.course-content .current .left,
.course-content .current
h3.weekdates{color:#2d83d5 !important}.forumpost
.topic{background:#fff url(image.php?theme=fusion&image=grad&rev=159&component=theme) repeat-x 0 100%;padding:0
10px 0;border:1px
solid #eee}.forumpost
.subject{font-size:1.5em;font-family:"Palatino Linotype",Georgia,"Tahoma","Century Schoolbook L",Arial,Helvetica}.forumpost
.author{font-size:0.9em;font-style:italic}.forumpost
.content{border-width:0 1px 1px;border-style:solid;border-color:#aaa #eee #eee;padding:5px
10px 10px}#dock{background:#eee;border:none}#dock
.firstdockitem{margin-top:15px}#dock
.dockeditem{background-color:#fff;border:1px
solid #eee;border-width:0 1px 1px 0;padding:3px
0}#dock .dockeditem
.dockedtitle{border:none}#dock .dockeditem .dockedtitle
h2{margin:12px
0 12px 7px;color:#666}#dockeditempanel
.dockeditempanel_content{border-color:#eee}#dockeditempanel
.dockeditempanel_hd{border-bottom:none;padding:3px
5px;background:#eee;text-align:left}#dockeditempanel .dockeditempanel_hd
h2{color:#333;text-align:right;font-weight:normal;font-size:0.8em;padding:0
2px}#dockeditempanel .dockeditempanel_hd
.commands{float:right}.pagelayout-redirect{background-position:0 0}body{margin:auto 0px;width:auto}#page{width:100%}#page-header{float:left;width:100%}#page-content{clear:both;float:left;overflow:hidden;position:relative;width:100%}#page-content #region-main-box{float:left;right:28%;position:relative;width:100%}#page-content #region-post-box{float:left;right:72%;position:relative;width:100%}#page-content #region-main{float:left;overflow:hidden;position:relative;margin-right:0px;left:100%;width:72%}#page-content #region-post{float:left;overflow:hidden;position:relative;left:100%;width:28%}#page-content #region-main .region-content{overflow:hidden;padding:50px
15px 20px 0}#page-content #region-post .region-content{overflow:hidden;padding:0
0 0 10px}#page-footer{clear:both;float:left;width:100%}.content-only #page-content #region-main-box{right:0%}.content-only #page-content #region-post-box{right:100%}.content-only #page-content #region-main{left:100%;width:100%}.content-only #page-content #region-pre{width:0%}.content-only #page-content #region-post{width:0%}.pagelayout-report #page-content #region-main{overflow:auto}.pagelayout-report #page-content #region-main .region-content{overflow:visible}#custommenu{font-size:1.2em;line-height:1.2;float:left;width:60%}.yui3-skin-sam .yui3-menu-content,
.yui3-skin-sam .yui3-menu .yui3-menu .yui3-menu-content{border:none;padding:0
!important}.yui3-skin-sam .yui3-menu .yui3-menu .yui3-menu-content{background:#fff;filter:alpha(opacity=95);-moz-opacity:0.95;-khtml-opacity:0.95;opacity:0.95;padding:5px
0}.yui3-skin-sam .yui3-menu-horizontal .yui3-menu-content{}.yui3-skin-sam .yui3-menu ul,
.yui3-skin-sam .yui3-menu ul
ul{}.yui3-skin-sam .yui3-menu ul.first-of-type{}.yui3-skin-sam .yui3-menu-horizontal
ul{}.yui3-skin-sam .yui3-menu li,
.yui3-skin-sam .yui3-menu .yui3-menu
li{}.yui3-skin-sam .yui3-menu-horizontal
li{}.yui3-skin-sam .yui3-menubuttonnav
li{}.yui3-skin-sam .yui3-splitbuttonnav
li{}.yui3-skin-sam .yui3-menubuttonnav li li,
.yui3-skin-sam .yui3-splitbuttonnav li
li{}.yui3-skin-sam .yui3-menu .yui3-menu{padding-top:5px;background:url(image.php?theme=fusion&image=menu-top&rev=159&component=theme) no-repeat 20px 0;filter:alpha(opacity=95);-moz-opacity:0.95;-khtml-opacity:0.95;opacity:0.95}.custom_menu_submenu
.custom_menu_submenu{filter:alpha(opacity=100);-moz-opacity:1 !important;-khtml-opacity:1 !important;opacity:1 !important}.yui3-skin-sam .yui3-menu .yui3-menu .yui3-menu{padding-top:0;background:none}.yui3-skin-sam .yui3-menuitem-content,
.yui3-skin-sam .yui3-menu-label{color:#a2a3a6}.yui3-skin-sam .yui3-menuitem-content,
.yui3-skin-sam .yui3-menu .yui3-menu .yui3-menuitem-content{padding-top:3px;padding-bottom:4px}.yui3-skin-sam .yui3-menu-horizontal .yui3-menu-label,
.yui3-skin-sam .yui3-menu-horizontal .yui3-menuitem-content{border:none;padding:0
20px 0 0}.yui3-skin-sam .yui3-menu-label,
.yui3-skin-sam .yui3-menu .yui3-menu .yui3-menu-label{padding-top:3px;padding-bottom:4px}.yui3-skin-sam .yui3-menu-horizontal .yui3-menu-label{}.yui3-skin-sam .yui3-menubuttonnav .yui3-menu-label,
.yui3-skin-sam .yui3-splitbuttonnav .yui3-menu-label{}.yui3-skin-sam .yui3-menubuttonnav .yui3-menu-label{}.yui3-skin-sam .yui3-menubuttonnav .yui3-menu-label
em{}.yui3-skin-sam .yui3-splitbuttonnav .yui3-menu-label{}.yui3-skin-sam .yui3-splitbuttonnav .yui3-menu-label
a{}.yui3-skin-sam .yui3-splitbuttonnav .yui3-menu-label .yui3-menu-toggle{}.yui3-skin-sam .yui3-menu-label-active,
.yui3-skin-sam .yui3-menu-label-menuvisible,
.yui3-skin-sam .yui3-menu .yui3-menu .yui3-menu-label-active,
.yui3-skin-sam .yui3-menu .yui3-menu .yui3-menu-label-menuvisible{color:#fff;background-color:#2d83d5}.yui3-skin-sam .yui3-menuitem-active .yui3-menuitem-content,
.yui3-skin-sam .yui3-menu .yui3-menu .yui3-menuitem-active .yui3-menuitem-content{color:#fff;background-color:#2d83d5}.yui3-skin-sam .yui3-menu-horizontal .yui3-menu-label-active,
.yui3-skin-sam .yui3-menu-horizontal .yui3-menuitem-active .yui3-menuitem-content,
.yui3-skin-sam .yui3-menu-horizontal .yui3-menu-label-menuvisible{}.yui3-skin-sam .yui3-menubuttonnav .yui3-menu-label-active,
...
.yui3-skin-sam .yui3-splitbuttonnav .yui3-menu-label-menuvisible{}.yui3-skin-sam .yui3-splitbuttonnav .yui3-menu-label-menuvisible{}.yui3-skin-sam .yui3-splitbuttonnav .yui3-menu-label-menuvisible .yui3-menu-toggle{}#custommenu .yui3-menu-horizontal.javascript-disabled .yui3-menu-content,
#custommenu .yui3-menu-horizontal.javascript-disabled .yui3-menu-content
.ul{border:none !important}#custommenu .yui3-menu-horizontal.javascript-disabled li
a{padding:0
20px 0 0}a{color:#2d83d5}